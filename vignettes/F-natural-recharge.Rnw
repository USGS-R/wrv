...
For this study, the volumetric flow rate across the water table is dependent on the rate and duration of precipitation and evapotranspiration (ET), land cover land use, and soil type.
...
Natural groundwater recharge and discharge are only applicable on non-irrigated lands, where flow across the water table is unaffected by irrigation and water diversions.
...
The water-balance model (equation~\ref{eq:rech}) was used to calculate the volumetric flow rate across the water table of natural groundwater recharge and discharge ($Q_{\mathit{nat}}$) beneath non-irrigated lands during each month of the transient simulation (1995--2010).

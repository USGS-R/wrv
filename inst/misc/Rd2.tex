...
a Keyhole Markup Language (\Rhref{http://en.wikipedia.org/wiki/Kml}{KML}) file created in
\Rhref{http://www.google.com/earth/}{Google Earth} with polygons drawn by hand in
...
%
\begin{Source}\relax
National Water Information System (\Rhref{http://waterdata.usgs.gov/nwis}{NWIS}),
...
(\Rhref{http://waterdata.usgs.gov/nwis}{NWIS}) database on December 15, 2014,
...
MAF/\Rhref{http://www.census.gov/geo/maps-data/data/tiger.html}{TIGER} geographic database.
\end{Source}
%
\begin{Examples}
\begin{ExampleCode}
...
%
\begin{Source}\relax
The National Elevation Dataset (\Rhref{http://ned.usgs.gov/}{NED})
...
\Rhref{http://viewer.nationalmap.gov/viewer/}{National Map Viewer}.
...
(1) project the values of the NED dataset into the \code{\LinkA{alluvium.thickness}{alluvium.thickness}}
...
(\Rhref{http://www.nws.noaa.gov/om/coop/}{NWS}) Cooperative Observer Program

U.S. Bureau of Reclamation's Cooperative Agricultural Weather Network
(\Rhref{http://www.usbr.gov/pn/agrimet/}{AgriMet})
\end{References}
%
\begin{SeeAlso}\relax
...
\Rhref{http://en.wikipedia.org/wiki/Darcy_law}{Darcian} analysis.
...
The U.S. Geologic Survey \Rhref{http://water.usgs.gov/osw/streamstats/}{StreamStats} tool
...
\Rhref{http://water.usgs.gov/ogw/modflow/}{MODFLOW} Well Package file (\file{.wel}).
...
\Rhref{http://water.usgs.gov/GIS/metadata/usgswrd/XML/sir2007-5258_oct2006wl.xml}{WRD NSDI Node}.
\end{Source}
%
\begin{References}\relax
...
\Rhref{http://water.usgs.gov/ogw/mfusg/}{MODFLOW-USG} groundwater-flow model.
...
\Rhref{http://water.usgs.gov/nrp/gwsoftware/modflow2005/Guide/index.html}{MODFLOW-2005}, and
(3) allow any MODFLOW post-processor to be used to analyze the results of the MODFLOW-USG simulation
(such as \Rhref{http://water.usgs.gov/nrp/gwsoftware/modelviewer/ModelViewer.html}{Model Viewer}).

...
%
\begin{Description}\relax
This function estimates groundwater flow across the water table, and pumping demand at production wells.
...
\end{Examples}
\inputencoding{utf8}
\HeaderA{tributaries}{Groundwater Flow in the Tributary Canyons}{tributaries}
...
\item[\code{rech}] \code{data.frame}; is the groundwater flow across the water table, in cubic meters per day.
